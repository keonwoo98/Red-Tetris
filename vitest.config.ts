  ...
  test: {
    ...
    coverage: {
      ...
      exclude: [
        ...
        'packages/client/src/components/GameRoute.tsx',
        'packages/client/src/components/GameView.tsx',
        'packages/client/src/components/test-utils.tsx',
        'packages/client/src/hooks/useGameLoop.ts',
